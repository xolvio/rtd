...
(function () {
    ...
    var seleniumServerVersion, seleniumServerSha, seleniumServerFilename, seleniumServerUrl, seleniumServerOutputFile,
        chromeDriverOs, chromeDriverVersion, chromeDriverSha, chromeDriverFilename, chromeDriverUrl, chromeDriverOutFile, chromeDriverExecutable;
    ...
    function init(options) {
        ...
        seleniumServerFilename = 'selenium-server-standalone-' + seleniumServerVersion + '.jar',
            ...
            chromeDriverFilename = 'chromedriver2_' + chromeDriverOs + '_' + chromeDriverVersion + '.zip',
